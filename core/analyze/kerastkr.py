...
import core.analyze.pgdb as pgdb
...
def learn_predict_kerasnn(tkr='IBM'
    ...
    # Predict xtest_a then update out_df
...
def load_predict_keraslinear(tkr='FB', yrs=3, mnth='2017-08', features='pct_lag1,slope4,moy'):
    ...
    db = pg.PostgreDB('postgres://tkrapi:tkrapi@127.0.0.1/tkrapi')
