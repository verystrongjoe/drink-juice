...
def get_data(symbols, dates):
    ...
    for symbol in symbols:
        df_temp = pd.read_csv("../data/raw/tkrcsv/history/{}.csv".format(symbol), index_col='Date',
